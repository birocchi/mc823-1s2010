...
Para contornar isso, implementamos uma espécie de \textit{time-out} para o recebimento de respostas pelo cliente. Seu funcionamento se dá como segue:\\
...
Dessa forma, o processo cliente entra em espera ocupada (ocupando processamento), mas não trava indefinidamente no caso de perda de pacotes.
