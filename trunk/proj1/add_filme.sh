...
tam_substr=$(echo -n $id\@0\@000000\@$titulo\@$sinopse\@$sala\@$horarios\@ | wc -c)

# tam_reg deve ser tam_substr + 3~4 (digitos+@)
tam_reg=$(echo -n $tam_substr\@$id\@0\@000000\@$titulo\@$sinopse\@$sala\@$horarios\@ | wc -c)
...
echo -n $tam_reg\@$id\@0\@000000\@$titulo\@$sinopse\@$sala\@$horarios\@ >> filmes.dat
